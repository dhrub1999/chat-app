...
const ChatInput: FC<ChatInputProps> = ({ chatPartner, chatId }) => {
  ...
  return (
    <div className='mb-1 border-t border-slate-300 px-3 pt-4 sm:mb-0'>
      <div className='relative flex-1 overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-400 focus-within:ring-2 focus-within:ring-indigo-600'>
        <TextareaAutosize
          ...
          className='block w-full resize-none border-0 bg-transparent font-raleway text-sm font-medium text-gray-900 placeholder:text-gray-500 focus:ring-0 sm:py-1.5 sm:leading-6 md:text-base'
        />
