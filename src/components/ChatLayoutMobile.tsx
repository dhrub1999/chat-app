...
import UserFriendRequestInSidebar from './UserFriendRequestInSidebar';
...
const ChatLayoutMobile: FC<ChatLayoutMobileProps> = ({
  friends,
  session,
  sidebarOptions,
  unseenRequestCount,
                    ...
                    <div className='flex h-full flex-col overflow-hidden bg-white py-6 shadow-xl'>
                      <div className='px-4 sm:px-6'>
                        <div className='flex items-start justify-between'>
                          <Dialog.Title className='font-raleway text-base font-extrabold leading-6 text-gray-900'>
                            Dashboard
                          </Dialog.Title>
                      ...
                      <div className='relative mt-6 flex-1 px-4 font-raleway sm:px-6'>
                        {/* Content */}
                              ...
                              <ul role='list' className='-mx-2 mt-2 space-y-1'>
                                ...
                                <li>
                                  <UserFriendRequestInSidebar
                                    userFriendRequestCount={unseenRequestCount}
                                    sessionId={session.user.id}
                                  />
                                </li>
                              </ul>
